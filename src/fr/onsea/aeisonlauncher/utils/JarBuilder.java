...
public class JarBuilder
{
	...
	public JarBuilder(final String mainPathIn)
	{
		this.mainPath = mainPathIn;
	}

	public JarBuilder(final String mainPathIn, final String javaPathIn)
	{
		this.mainPath	= mainPathIn;
	...
	public final JarBuilder main(final String mainPathIn)
	{
		this.mainPath = mainPathIn;
	...
	public final String buildJavacCommand() throws Exception
	{
		...
		{
			javacCommand += " -s \"" + this.outputPath + "\"";
		}

		return javacCommand + " " + this.mainPath;
	}
}